        ...
        <DrawerContent className="sidebar-mobile">
          ...
          <DrawerBody pb="6em">
            ...
            <Flex direction="column">
              <Link to="https://github.com/rimondutta" target="_blank" display="block" mb={2} onClick={() => setDrawerOpen(false)}>
              ...
              <Link to="https://rimon-dutta.netlify.com/" target="_blank" display="block" mb={2} onClick={() => setDrawerOpen(false)}>
